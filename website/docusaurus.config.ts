		...
		metadata: [
			{
				name: "keywords",
				content:
					"git worktree cli, git worktree navigation, multi repo worktree, pull request review cli, git stash alternative, ai coding workflow",
			},
			{
				name: "twitter:card",
