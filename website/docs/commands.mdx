...
| --- | --- |
| `gji new [branch] [--from-current] [--detached] [--take] [--copy] [--force] [--open] [--editor <cli>] [--dry-run] [--json]` | Create a branch and worktree, optionally carrying uncommitted changes and CoW-bootstrap configured directories. |
