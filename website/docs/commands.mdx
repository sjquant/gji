...
needing attention, and collapses quiet worktrees. Use `gji --json` for
dashboard, IDE, fzf, and other ecosystem integrations; the JSON projection
remains additive to the existing `ls --json` and `status --json` contracts.
