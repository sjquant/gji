...
This requires a clean current worktree, updates the configured default branch
in place, and checks out the new branch there. Use `--no-fetch` when the local
default branch should be used as-is.
