...
function SiteHead({
	...
	return (
		<Head>
			...
			<meta
				property="og:title"
				content="gji | Git worktrees without the hassle"
			/>
			...
			<div className={clsx("container", styles.heroInner)}>
				<div className={styles.heroCopy}>
					...
					<p className={styles.heroSupport}>
						It adds navigation, shell handoff, predictable paths, and commands
						for creating, opening, syncing, and removing worktrees.
					</p>
		...
		<section className={styles.band}>
			<div className={clsx("container", styles.bandGrid)}>
				...
				<div className={styles.problemBox}>
					...
					<p>
						Stash changes, checkout another branch, reinstall dependencies, do
						the work, then switch everything back.
					</p>
				</div>
				<div className={styles.solutionBox}>
					<p className={styles.problemLabel}>With gji</p>
					<p>
						Open each task in its own worktree and switch directly between
						feature work, PR review, cleanup, and cross-repo tasks.
					</p>
				</div>
			</div>
		</section>
